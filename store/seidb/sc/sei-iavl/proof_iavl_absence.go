...
import (
	...
	iavlproto "cosmossdk.io/store/seidb/sc/sei-iavl/proto"
)
...
func AbsenceOpDecoder(pop cmtprotocrypto.ProofOp) (merkle.ProofOperator, error) {
...
func (op AbsenceOp) ProofOp() cmtprotocrypto.ProofOp {
