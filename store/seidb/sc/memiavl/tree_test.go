...
import (
	...
	cosmosiavl "cosmossdk.io/store/seidb/sc/sei-iavl"
	iavldb "cosmossdk.io/store/seidb/sc/sei-iavl/db"
...
func init() {
	...
	d := iavldb.NewMemDB()
	refTree := cosmosiavl.NewMutableTree(d, 0, true, nil)
...
func applyChangeSetRef(t *cosmosiavl.MutableTree, changes iavl.ChangeSet) error {
